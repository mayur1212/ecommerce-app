...
// seller slug helper – "HILL TOP FASHION" -> "hill-top-fashion"
...
// -----------------------------------------
// GENERIC PRICE HELPER  (product + variant)
// -----------------------------------------
...
/* ---------------- SELLER + RATING SECTION (below tabs) --------------- */
...
function SellerSection({ ratingValue, ratingCount, sellerName, sellerStats }) {
  ...
  return (
    <section className="mt-8 space-y-4">
      ...
      <div className="rounded-2xl border bg-white p-4 sm:p-5 shadow-sm">
        ...
        {/* VIEW ALL REVIEWS */}
        <button className="mt-4 w-full rounded-lg border border-violet-500 py-2 text-xs sm:text-sm font-semibold text-violet-600 hover:bg-violet-50">
          VIEW ALL REVIEWS →
        </button>
      </div>
...
export default function ProductsDetails() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-3 sm:px-4 md:px-6 py-4">
        ...
        <div className="lg:w-[55%] w-full flex flex-col gap-4 mt-4 lg:mt-0">
          ...
          <div className="mt-3 space-y-3">
            <div className="bg-gray-50 rounded-2xl border p-4">
              ...
              {youSave > 0 && (
                <p className="text-sm text-gray-700 mt-2">
                  You save <b>{formatPrice(youSave)}</b> per item
                </p>
              )}
            ...
            <div className="bg-white border rounded-2xl p-4 text-sm text-gray-700">
              ...
              <p>
                <b>Warranty:</b> {product.warranty ?? "No warranty info"}
              </p>
              <p>
                <b>Return Policy:</b>{" "}
              ...
              <p>
                <b>SKU:</b> {product.sku_id || product.sku}
              </p>
              {product.weight && (
                <p>
            ...
            <div>
              ...
              {ratingCount === 0 ? (
                ...
                <p className="text-gray-500">
                  {ratingCount} reviews will be displayed here.
                </p>
              )}
            </div>
          )}
      ...
      {/* ⭐ SOLD BY + PRODUCT RATING SECTION UNDER TABS */}
      <SellerSection
