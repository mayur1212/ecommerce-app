...
export default function ProductsList() {
  // wishlist state (product.id => true/false)
  ...
  // helper to check stock (checks variants first, then product.stock)
            ...
            >
              ...
              <div className="w-full aspect-[4/5] overflow-hidden rounded-lg mb-3 relative">
                ...
                <button
                  type="button"
                  onClick={(e) => {
                    e.preventDefault(); // link navigate hoऊ नये
                    e.stopPropagation();
